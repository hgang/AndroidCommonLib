...
public class ChartData {
	...
	public static final String LINE_COLOR = "#ffffff";
	...
	public ChartData addPoint(int x, float y, String title, String subtitle) {
	...
	public ChartData addPoint(int x, float y) {
